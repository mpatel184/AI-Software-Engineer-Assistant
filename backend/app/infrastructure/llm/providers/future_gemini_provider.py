"""Placeholder Gemini provider — not implemented (local-only project)."""
...
class FutureGeminiProvider(LLMProvider):
    name = "gemini"

    def __init__(self, settings: Settings) -> None:  # noqa: ARG002
        raise NotImplementedError(
            "GeminiProvider is not implemented. Set LLM_PROVIDER=qwen to use the "
